...
from config import URL_FRONTEND_DOE, URL_FRONTEND_CADASTRO
...
def active_account_email_template(name, token):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
                        ...
                        >
                            ...
                            >
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                    <a
                                        href="{URL_FRONTEND_CADASTRO}/?token={token}"
                                        target="_blank"
                                        style="display: inline-block"
                                    >
                                        <img
        ...
        <body>      
            <div class="centro">
                ...
                <div class="body">
                    ...
                    <p><br/><a class="botao" href="{URL_FRONTEND_CADASTRO}/delete-account/{token}">Excluir Minha Conta</a><br/><br/></p>
                        ...
                        >
                            ...
                            >
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                    <a
                                        href="{URL_FRONTEND_CADASTRO}{url_redirect}/{token}"
                                        target="_blank"
                                        style="display: inline-block"
                                    >
                                        <img
                        ...
                        >
                            ...
                            >
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                    <a
                                        href="{URL_FRONTEND_DOE}/benfeitor/campanha/{campanha_id}/doacao?token={token}&tipo_pagamento={tipo_pagamento}"
                                        target="_blank"
                                        style="display: inline-block"
                                    >
                                        <img
        ...
        <body>       
            <div class="centro">
                ...
                <div class="body">
                    ...
                    <p><br/><a class="botao" href="{URL_FRONTEND_CADASTRO}/?token={token}">Ativar Conta</a><br/><br/></p>
...
def send_cadastro_vocacional(name, url_formulario_cadastro, url_desistensia, imagem_etapa):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            <strong>Seja bem vindo a próxima etapa</strong>
                                            </h1>
                                        </td>
                                        </tr>
                                        <tr style="border-collapse: collapse">
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            Ao clicar no link no botão preencher cadastro você será redirecionado para preencher o nosso formulário, recomendamos que faça com algum tempo livre para não cometer equívocos no preenchimento dos dados.
                                            <br />
                                            </p>
                                            <p
                                            style="
                                            ...
                                            <div style="text-align: center; margin: 20px 0;">
                                                <a href="{URL_FRONTEND_CADASTRO}/{url_formulario_cadastro}" 
                                                style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 0 10px;">
                                                Preencher etapa
                                                </a>
                                                <a href="{URL_FRONTEND_CADASTRO}/{url_desistensia}" 
                                                style="display: inline-block; padding: 10px 20px; background-color: #f44336; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 0 10px;">
                                                Desistir do processo vocacional
                                                </a>
                                            </div>
					                        <p
                                            style="
...
def send_congratulations_vocacional(name, imagem_etapa):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            É com grande alegria que celebramos esta conquista tão especial na sua vida! A aprovação no processo vocacional é um marco significativo, fruto da sua dedicação, discernimento e, acima de tudo, da confiança no chamado que Deus colocou no seu coração.
                                            Que este novo passo seja repleto de luz, sabedoria e graça divina. Que você continue a se deixar guiar pelo Espírito Santo, cultivando a fé, o amor e o serviço ao próximo. Lembre-se de que cada desafio será uma oportunidade para crescer e se aproximar ainda mais da missão que o Senhor preparou para você.
                                            Parabéns por responder "sim" ao chamado de Deus!
                                            <br />
                                            </p>                                          
					                        <p
                                            style="
...
def send_email_pre_cadastro_vocacional_recebido(name, imagem_etapa):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
...
def thanks_for_donation(name, nome_campanha, foto_campanha):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
...
def send_email_cadastro_vocacional_recebido(name, imagem_etapa):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            <strong>Cadastro vocacional Recebido</strong>
                                            </h1>
                                        </td>
                                        </tr>
                                        <tr style="border-collapse: collapse">
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            Temos a satisfação em comunicar que recebemos o preechimento da ficha cadastral no processo vocacional, iremos analisar seu cadastro e em breve lhe daremos retorno!
...
def send_email_ficha_vocacional_recebido(name, imagem_etapa):
    template = (
        TEMPLATE_HEAD
        + f"""
        <body
                                ...
                                <tr style="border-collapse: collapse">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            <strong>Ficha vocacional Recebida</strong>
                                            </h1>
                                        </td>
                                        </tr>
                                        <tr style="border-collapse: collapse">
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                            Temos a satisfação em comunicar que recebemos o preechimento da ficha vocacional, iremos analisar seus dados e em breve lhe daremos retorno!
