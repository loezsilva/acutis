...
class BuscarEnderecoFamiliaAgapeUseCase:
    ...
    def execute(self, familia_id: UUID) -> EnderecoResponse:
        familia_agape = self._agape_repository.buscar_familia_por_id(familia_id)
        ...
        endereco_familia = self._agape_repository.buscar_endereco_por_id(familia_agape.fk_endereco_id)
