...
class ListarHistoricoMovimentacoesAgapeUseCase:
    """
    Caso de uso para listar o histórico de movimentações do estoque ágape com paginação.
    """
    ...
    def execute(
        ...
        total_paginas = (
            math.ceil(
                total_itens / filtros.por_pagina
            ) if filtros.por_pagina > 0 else 0
        )
        if total_paginas == 0 and total_itens > 0 : # Caso onde por_pagina é 0 mas há itens
             total_paginas = 1
